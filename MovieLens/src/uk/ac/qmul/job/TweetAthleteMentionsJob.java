...
import uk.ac.qmul.mapper.TweetAthleteMentionsMapper;
import uk.ac.qmul.reducer.TweetAthleteMentionsReducer;

public class TweetAthleteMentionsJob {
	...
	public static void runJob(String input1, String input2,String output) throws Exception {
		...
		job.setJarByClass(TweetAthleteMentionsJob.class);
		job.setMapperClass(TweetAthleteMentionsMapper.class);
